...
def load_dataset(dataset):
    ...
    hgraph['kg1_entities'].x = entity_kg1_attr
    ...
    # new add 
    hgraph['news', 'has', 'kg1_entities'].edge_index = (n_h_e1.t().contiguous())
    hgraph['kg1_entities', 'in', 'news'].edge_index = (e_i_n1.t().contiguous())

    hgraph['kg_entities', 'to', 'entities'].edge_index = (kg_t_e1.t().contiguous())
    hgraph['kg1_entities', 'to', 'entities'].edge_index = (kg_t_e1.t().contiguous())
